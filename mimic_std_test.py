...
if options.task_name == '':
    train_set = pickle.load(open("./data/inhospital/train1.pkl", "rb"))
else:
    print(options.task_name)
    train_set = pickle.load(open("{}/mimic1.pkl".format(options.task_name), "rb"))
d_P = train_set["dynamic_processor"]
